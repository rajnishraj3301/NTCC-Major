...
import com.shandilyaOam.d8gmusicPlayer.R
import com.shandilyaOam.d8gmusicPlayer.databinding.ActivityMainBinding
import java.io.File
...
//                R.id.navFeedback -> startActivity(Intent(this@MainActivity, FeedbackActivity::class.java))
                ...
                R.id.navCredits -> startActivity(Intent(this@MainActivity,credits_activity::class.java))
                R.id.navExit -> {
