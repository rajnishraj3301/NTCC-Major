...
import com.shandilyaOam.d8gmusicPlayer.databinding.ActivityPlayerBinding
import com.shandilyaOam.d8gmusicPlayer.databinding.AudioBoosterBinding
...
class PlayerActivity : AppCompatActivity(), ServiceConnection, MediaPlayer.OnCompletionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.timerBtnPA.setOnClickListener {
            val timer = min5 || min10 || min15 || min30 || min60
...
//Important Function
    ...
    private fun setLayout(){
        ...
        if(min5 || min10 || min15 || min30 || min60) binding.timerBtnPA.setColorFilter(ContextCompat.getColor(applicationContext, R.color.purple_500))
